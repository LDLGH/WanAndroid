...
class LoginAndRegisterPresenter @Inject constructor(var dataManager: DataManager) :
    ...
    override fun register(username: String?, password: String?) {
        addSubscribe(dataManager.getRegisterData(username, password, password)
            .compose(RxUtils.rxSchedulerHelper())
            .compose(RxUtils.handleResult())
            .subscribe({
                login(username, password)
            }, {
                LogUtils.d(StringUtils.getString(R.string.register_fail))
            })
//            .subscribeWith(object :
//                BaseObserver<LoginData>(
//                    mView!!,
//                    StringUtils.getString(R.string.register_fail)
//                ) {
//                override fun onNext(t: LoginData) {
